...
/* Number Pad/nav cluster
 *
 * ,-----------------------------------------------------------------------------------.
 * | CAPS | PSCRN| SCRL | PAUSE|      |      |      |   7  |   8  |   9  |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |  INS | HOME | P_UP |      |      |      |   4  |   5  |   6  |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |  DEL | END  | P_DN |      |      |      |   1  |   2  |   3  |      |      |
...
[_NUM] = LAYOUT_planck_grid(
    KC_CAPS, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, _______, KC_P7,    KC_P8,    KC_P9,   _______, _______,
